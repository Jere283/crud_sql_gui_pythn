...
class Countries:
    ...
    def __init__(self):
        self.cnn = pyodbc.connect("DRIVER={ODBC Driver 18 for SQL Server};SERVER=DESKTOP-RQR718R;DATABASE=tarea1;UID=jere283;PWD=admin;Encrypt=yes;TrustServerCertificate=yes;")
